...
namespace IJunior.TypedScenes
{
    ...
    public class _1_FruitVaseScene_CelShadingMode_None_CompletelyFlat : TypedScene
    {
        
        private const string _sceneName = "_1_FruitVaseScene_CelShadingMode_None_CompletelyFlat";
