...
namespace IJunior.TypedScenes
{
    ...
    public class _5_FruitVaseScene_Var_StylizedSurfaceShaderWithOutlines : TypedScene
    {
        
        private const string _sceneName = "_5_FruitVaseScene_Var_StylizedSurfaceShaderWithOutlines";
